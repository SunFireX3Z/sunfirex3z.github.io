...
function ShareButton() {
    ...
    return (
        <button onClick={handleShare} className="flex w-full items-center justify-center gap-3 rounded-lg bg-orange-600 px-4 py-3 text-lg font-bold text-white shadow-lg transition-all duration-300 hover:scale-101 hover:bg-orange-700 focus:outline-none focus:ring-4 focus:ring-orange-300">
