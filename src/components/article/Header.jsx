        ...
        <header className="sticky top-0 z-10">
                ...
                <div className="max-w-[90rem] mx-auto flex flex-row justify-between items-center py-3 px-6">
                    ...
                    <div className="hidden lg:flex items-center gap-8">
                        <nav className="flex items-center gap-8 text-base">
                            ...
                            <NavLink href="/blog/arsip" currentPath={currentPath} className={({ isActive }) => `py-2 transition-colors duration-200 ${isActive ? 'font-semibold text-white' : 'font-medium text-white/70 hover:text-orange-500'}`}>Arsip</NavLink>
            ...
            <div className={`lg:hidden ${isMenuOpen ? 'block' : 'hidden'} absolute w-full bg-white shadow-lg z-10`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <NavLink href="/blog/arsip" onClick={closeMenu} currentPath={currentPath} className={({ isActive }) => `block px-3 py-2 rounded-md text-base font-medium transition-colors ${isActive ? 'text-orange-500 bg-orange-50' : 'text-gray-700 hover:text-orange-500 hover:bg-gray-50'}`}>Arsip</NavLink>
