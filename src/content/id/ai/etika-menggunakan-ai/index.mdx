...
export const metadata = {
    ...
    metaDescription: "Pelajari etika penggunaan AI agar karya tetap original. Ketahui cara menghindari plagiarisme, memverifikasi informasi, menghormati hak cipta, dan memanfaatkan AI secara bertanggung jawab.",
    publishDate: "2026-07-02",
    lastUpdated: "2026-07-16",
    updatedReason: "Memperbarui isi artikel agar lebih akurat dan mudah dipahami.",
    series: "",
    status: "Published",
    author: "Airi",
    category: "AI",
    subcategory: "Etika AI",
